...
print(txt.format(age))      # will be: My name is John, and I am 36
...
# will be: I want 3 pieces of item 567 for 49.95 dollars.
...
# will be: I want to pay 49.95 dollars for 3 pieces of item 567.