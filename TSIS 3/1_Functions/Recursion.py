...
amounts of memory or processor power. However, when written correctly recursion can 
...
we recurse. The recursion ends when the condition is not greater than 0 (i.e. when it is 0).
