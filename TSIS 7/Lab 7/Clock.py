...
bg = pygame.image.load(r'/Users/snezhok/Desktop/PP2/TSIS 7/Lab 7/Clock/bb.png').convert()
bg_rect = bg.get_rect()
image_left = pygame.image.load(r"/Users/snezhok/Desktop/PP2/TSIS 7/Lab 7/Clock/second.png")
left_rect = image_left.get_rect(bottomleft = (415,560))
image_right = pygame.image.load(r"/Users/snezhok/Desktop/PP2/TSIS 7/Lab 7/Clock/minute.png")
